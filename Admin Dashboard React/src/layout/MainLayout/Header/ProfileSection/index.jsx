...
// ** Tambahan import useAuth **
import { useAuth } from 'contexts/AuthContext';  // sesuaikan path ini jika berbeda
...
export default function ProfileSection() {
  ...
  // ** Dapatkan setIsAuth dari context **
  ...
  const logout = async () => {
    try {
      ...
      setIsAuth(false);  // <-- update state context supaya user logout di seluruh app
      navigate('/login');
    } catch (e) {
